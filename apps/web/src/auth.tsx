    ...
    return (
      <main className={styles.page}>
        <Card className={styles.card}>
          <Title2>MOSAIC administrator access</Title2>
          <Text>
            Sign in with an account assigned the MOSAIC Admin application role.
          </Text>
          <Button
            appearance="primary"
            onClick={() =>
              void instance.loginRedirect({ scopes: [runtimeConfig.entraApiScope] })
            }
          >
