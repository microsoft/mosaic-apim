...
const sampleConnections: PreviewFoundryConnection[] = [
  ...
  },
  {
    ...
    endpoint: 'https://mosaic-weu.openai.azure.com',
    azureResourceId:
      '/subscriptions/sample-sub/resourceGroups/mosaic-preview/providers/Microsoft.CognitiveServices/accounts/mosaic-weu',
...
const sampleDeployments: PreviewModelDeployment[] = [
  ...
  },
  {
    ...
    endpoint:
      'https://mosaic-weu.openai.azure.com/openai/deployments/assistant-archive/chat/completions',
    requestPath: '/chat/completions',
    regionLabel: 'West Europe',
    status: 'stopped',
